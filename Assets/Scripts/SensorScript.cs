...
public class SensorScript : MonoBehaviour
{
    ...
    public float distanceOfTarget = 5f;
    ...
    void Update()
    {
        ...
        //ODLEGLOSC KRYTYCZNA
        if (distances[0] < distanceOfTarget && distances[0] > 1)
        {
            sensorUP.enabled = true;
            Debug.Log("Czujnik UP uruchomiony! Dystans do obiektu: " + distances[0]);
        }
        else if (distances[1] < distanceOfTarget && distances[1] > 1)
        {
            sensorLEFT.enabled = true;
            Debug.Log("Czujnik RIGHT uruchomiony! Dystans do obiektu: " + distances[1]);
        }
        else if ((distances[2] < distanceOfTarget && distances[2] > 1) || (distances[3] < distanceOfTarget && distances[3] > 1))
        {
            sensorDOWN.enabled = true;
            Debug.Log("Czujnik DOWN uruchomiony! Dystans do obiektu: " + distances[2]);

        }
        else if (distances[4] < distanceOfTarget && distances[4] > 1)
        {
            sensorRIGHT.enabled = true;
            Debug.Log("Czujnik LEFT uruchomiony! Dystans do obiektu: " + distances[4]);
        }
        else if ((distances[0] < distanceOfTarget && distances[0] > 1) && (distances[1] < distanceOfTarget && distances[1] > 1))
        {
            sensorUP.enabled = true;
            sensorLEFT.enabled = true;
            Debug.Log("Czujnik UP and RIGHT  uruchomiony! Dystans do obiektu: " + distances[0]);
        }
        else if ((distances[0] < distanceOfTarget && distances[0] > 1) && (distances[4] < distanceOfTarget && distances[4] > 1))
        {
            sensorUP.enabled = true;
            sensorRIGHT.enabled = true;
            Debug.Log("Czujnik UP and LEFT  uruchomiony! Dystans do obiektu: " + distances[0]);
        }
        else if ((distances[1] < distanceOfTarget && distances[1] > 1) && (distances[2] < distanceOfTarget && distances[2] > 1))
        {
            sensorLEFT.enabled = true;
            sensorDOWN.enabled = true;
            Debug.Log("Czujnik DOWN and RIGHT  uruchomiony! Dystans do obiektu: " + distances[1]);
        }
        else if ((distances[3] < distanceOfTarget && distances[3] > 1) && (distances[4] < distanceOfTarget && distances[4] > 1))
        {
            sensorDOWN.enabled = true;
            sensorRIGHT.enabled = true;
